...
**适用场景**: 本地开发环境，使用 AI Agent 测试前后端功能\

**详细操作文章**: [https://blog.csdn.net/m0_74382565/article/details/159240982?spm=1011.2415.3001.10575&sharefrom=mp_manage_link](https://blog.csdn.net/m0_74382565/article/details/159240982?spm=1011.2415.3001.10575&sharefrom=mp_manage_link)
...
```
请访问 http://localhost:5173/login，分析登录页面后生成测试用例：
- 覆盖正常和异常场景
- 包含字段验证测试
- 添加截图步骤
```
...
- `samples/e2e/test-cases/user/user-edit.md`
...
2. e2e/test-cases/user/user-create.md
3. e2e/test-cases/user/user-edit.md
